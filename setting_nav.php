    ...
    <ul>
        ...
        <li>
            ...
            <div class="social-icons">
                ...
                <a href="">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_46_181)">
                            <path d="M12 0C5.37264 0 0 5.5965 0 12.5C0 18.362 3.87456 23.281 9.10128 24.632V16.32H6.62688V12.5H9.10128V10.854C9.10128 6.5995 10.9498 4.6275 14.9597 4.6275C15.72 4.6275 17.0318 4.783 17.5685 4.938V8.4005C17.2853 8.3695 16.7933 8.354 16.1822 8.354C14.2147 8.354 13.4544 9.1305 13.4544 11.149V12.5H17.3741L16.7006 16.32H13.4544V24.9085C19.3963 24.161 24.0005 18.891 24.0005 12.5C24 5.5965 18.6274 0 12 0Z" fill="white"/>
                        </g>
                        <defs>
                ...
                <a href="">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.7839 0H13.5706V17.029C13.5706 19.058 11.9502 20.7247 9.93361 20.7247C7.91702 20.7247 6.29655 19.058 6.29655 17.029C6.29655 15.0362 7.88101 13.4058 9.8256 13.3333V9.05799C5.54033 9.13042 2.08334 12.6449 2.08334 17.029C2.08334 21.4493 5.61235 25 9.96964 25C14.3269 25 17.8559 21.4131 17.8559 17.029V8.29708C19.4403 9.45653 21.3849 10.1449 23.4375 10.1812V5.9058C20.2686 5.7971 17.7839 3.1884 17.7839 0Z" fill="#FBFCEC"/>
                    </svg>
