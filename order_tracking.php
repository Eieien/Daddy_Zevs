        ...
        <div id="status">
            ...
            <div id="status_bar">
                <div class="icon_status">
                    <div>
                        <svg id="stat1" width="39" height="38" viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="icon_status">
                    <div>
                        <svg id="stat2" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="icon_status">
                    <div>
                        <svg id="stat3" width="39" height="38" viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="icon_status">
                    <div>
                        <svg id="stat4" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="summary">
            ...
            <?php
                if(isset($_SESSION["order"])){
                    ...
                    echo
                    "<style> #order-list{ margin-bottom: 50px; } </style>";
                }
            ?>
        </div>
    </div>
